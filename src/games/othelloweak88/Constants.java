...
public final class Constants {
    ...
    static public int GWIDTH = 480;    // 画面上の大きさ
    static public int GHEIGHT = GWIDTH;
    
    static public int WIDTH = 8;    // 盤の大きさ
    ...
    final static public int WCOMPUTER = 26;
    final static public int GUI = 27;
    final static public int NETWORK = 28;
